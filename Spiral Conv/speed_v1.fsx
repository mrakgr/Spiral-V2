// The cudnn activation functions have some overhead due to setting of those descriptors, but apart form that they are even.

// Moving on with testing of the cost functions.
...
let inline training_loop (data: DM) (targets: DM) =
    data |> squared_error_cost (dtrain.[1] |> fst) |> ignore
